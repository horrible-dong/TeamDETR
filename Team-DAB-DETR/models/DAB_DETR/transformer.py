...
def gen_sineembed_for_position(pos_tensor):
    ...
    if pos_tensor.size(-1) == 2:
        ...
        pos = torch.cat((pos_y, pos_x, pos_w, pos_h), dim=2)  # [Q, B, 512]
    else:
...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, refpoint_embed, pos_embed):
        ...
        # qt +tgt_mask=self.tgt_mask, refpoints_unsigmoid -> reference_points
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
                ...
                pos: Optional[Tensor] = None,
                reference_points: Optional[Tensor] = None,  # num_queries, bs, 4
                ):
        output = tgt
