...
def evaluate(model, criterion, postprocessors, data_loader, base_ds, device, output_dir, wo_class_error=False, args=None, logger=None):
    ...
    # qt +
    print(f"refpoints:\n{model_without_ddp.transformer.refpoint_embed.weight.data}")
    print(model.module.transformer.refpoint_embed.weight.data)
    ...
    if not args.no_ref_update:
        ...
        model_without_ddp.transformer.refpoint_embed.weight.data = centroids.to(device)
