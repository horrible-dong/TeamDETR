...
def get_args_parser():
    ...
    parser.add_argument('--config_file', '-c', type=str, default='config/DINO/DINO_4scale.py', required=True)
    ...
    # training parameters
    parser.add_argument('--output_dir', default='./runs/__tmp__',
...
def main(args):
    ...
    if args.start_epoch > args.lr_drop and not args.no_ref_update:
